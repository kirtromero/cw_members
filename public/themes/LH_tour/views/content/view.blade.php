         ...
         <div class="col-md-9">
            ...
            <div class="portfolio-container">
                            ...
                            <div id="portfolio" class="portfolio-masonry clearfix" data-lightbox="gallery">
                                ...
                                <article class="portfolio-item pf-media pf-icons">
                                    <div class="portfolio-image">
                                        <a href="{{ url('join') }}" data-lightbox="gallery-item">
                                            <img src="{{ config('yppcontent.thumb_url') }}/{{ $photo->thumb_location }}/{{ $item }}">
                                        </a>
                                        <a href="{{ url('join') }}" target="_blank" class="text-center">
                                            View Hi-Res Photo
                                        </a>
                                    </div>
                                </article>
                        ...
                        <div class="col_full portfolio-single-content clearfix">
                            <h1>REPLACE WITH BLOCKED IMAGE</h1>
                        </div>
                        @endforeach
                        @endif
                        ...
                        <div class="left-box" id="playerDetail">
                            <div class="inner">
                                ...
                                <div class="pdSRC">
                                    <p class="pull-left"> From DVD <a href="/dvds/deviant-step-sister-massages-3-908702">Deviant Step Sister Massages 3</a> </p>
                                    <!-- AddToAny BEGIN -->
                                ...
                                <div class="top">
                                    ...
                                    <div id="tab-embed" class="tabContent embed">
                                        <textarea name="embed" readonly="">&lt;iframe scrolling="no" width="600" height="371" src="http://www.lethalhardcore.com/embed/2969312" frameborder="0"&gt;&lt;/iframe&gt;&lt;p&gt;&lt;a href="http://www.lethalhardcore.com/april-brookes-loves-to-get-her-tight-pussy-filled-2969312"&gt;April Brookes Loves To Get Her Tight Pussy Filled&lt;/a&gt; from &lt;a href="http://www.lethalhardcore.com"&gt;Lethal Hardcore&lt;/a&gt;&lt;/p&gt;</textarea>
                                    </div>
                            ...
                            <div class="description">
                                <a href="/dvds/deviant-step-sister-massages-3-908702" class="sitelogo dvd-cover">
                                    <img src="http://images.lethalhardcore.com/dvds/small/DVD_25347_FR.jpg" alt="Deviant Step Sister Massages 3"></a>
                                ...
                                <div class="information">
                                    <div class="data">
                                        <div class="models-wrapper actors">
                                            @foreach($content->model_names as $actor)
                                            <a class="model" href="/pornstars/april-brookes"><img src="http://images.lethalhardcore.com/actors/5/51209/crop/56.jpg" alt="April Brookes"><span>{{ $actor }}</span></a>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="comments">
                                ...
                                <div class="col-md-6">
                                    <div class="inner">
                                        <div class="thumb-wrapper">
                                            <a href="{{ $similar->link }}">
                                                <img class="play-button" src="http://images.lethalhardcore.com/images/icon-play.svg" alt="">
